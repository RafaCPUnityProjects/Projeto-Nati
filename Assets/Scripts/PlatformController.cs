...
public class PlatformController : RaycastController
{
    ...
    Vector3 CalculatePlatformMovement()
    {
        ...
        Vector3 newPos = Vector3.Lerp(globalWaypoints[fromWaypointIndex], globalWaypoints[toWaypointIndex], Ease(percentBetweenWaypoints));
    ...
    void OnDrawGizmos()
    {
        if (localWaypoints != null)
        {
            ...
            for (int i = 0; i < localWaypoints.Length; i++)
            {
                ...
                Gizmos.DrawLine(globalWaypointsPos + Vector3.down * size, globalWaypointsPos + Vector3.up * size);
                Gizmos.DrawLine(globalWaypointsPos + Vector3.left * size, globalWaypointsPos + Vector3.right * size);
